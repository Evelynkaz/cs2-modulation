...
3. **Экран карты** — три шага слева, карта посередине, результаты справа.
   **1 Куда бросить** — точка (клик) или область падения («граната упала
   где угодно в области»). **2 Откуда бросать** — вся карта, спавны, точка
   или обведённая область (при многоэтажности — выбор этажа/высоты), плюс
   «Упор»: Любой / У стены / В углу. **3 Граната и бросок** — пока только
   смок; тип броска — Стоя / Присев / Прыжок / Присев + прыжок (броска с
   разбегом в интерфейсе нет — его нельзя повторить без тайминга разбега).
   ...
   Результаты справа: сложность (Лёгкая/Средняя/Сложная), пошаговая
   инструкция на русском, «Скопировать» строку `setpos …; setang …`, «Вид
   игрока» и три картинки, собранные по 3D-карте: прицел с увеличенной
   вставкой, где встать и куда упадёт.
